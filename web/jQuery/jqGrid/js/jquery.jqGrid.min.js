...
* Date:2010-12-14 
* Modules: grid.base.js; jquery.fmatter.js; grid.custom.js; grid.common.js; grid.formedit.js; jquery.searchFilter.js; grid.inlinedit.js; grid.celledit.js; jqModal.js; jqDnR.js; grid.subgrid.js; grid.grouping.js; grid.import.js; JsonXml.js; grid.setcolumns.js; grid.postext.js; grid.tbltogrid.js; grid.jqueryui.js; 
*/
(function(b){
    b.jgrid=b.jgrid||{};
...
var Ca=function(d,g,h,o){
    ...
    for(g=h[0]=h[1]=h[2]=0;g<=d;g++)if(a.p.colModel[g].hidden===false)h[0]+=a.p.colModel[g].width+o;if(a.p.direction=="rtl")h[0]=a.p.width-h[0];
...
footerData:function(f,j,i){
    function c(r){
        for(var t in r)if(r.hasOwnProperty(t))return false;return true
        }
        var e,k=false,n={},a;
...
DateFormat:function(a,b,d,f){
    ...
    var l=h.getSeconds(),o=h.getMilliseconds(),n=h.getDay(),p=h.getFullYear(),q=(n+6)%7+1,s=(new Date(p,e-1,b)-new Date(p,0,1))/864E5,t={
        d:i(b),
        D:k.i18n.dayNames[n],
        j:b,
        ...
        a(n.p.colModel).each(function(U){
            ...
            if(G!=="cb"&&G!=="subgrid"&&this.editable===true&&G!=="rn"){
                if(H===false)A="";
                    ...
                    rowabove:false,
                    rowcontent:""
                },this.formoptions||{}),ba=parseInt(X.rowpos,10)||L+1,ea=parseInt((parseInt(X.colpos,10)||1)*2,10);
...
if(d.grid&&e){
    var q=d.p.id,h="FrmGrid_"+q,j="TblGrid_"+q,k={
        ...
        q,
        scrollelm:h
    },E=a.isFunction(c.beforeShowForm)?c.beforeShowForm:false,P=a.isFunction(c.afterShowForm)?c.afterShowForm:false,l=a.isFunction(c.beforeInitData)?c.beforeInitData:false,u=a.isFunction(c.onInitializeForm)?c.onInitializeForm:false,t=true,I=1,i=0,f,J,R,O;
    if(e=="new"){
        e="_empty";
            ...
            a(f.p.colModel).each(function(A){
                ...
                if(O!=="cb"&&O!=="subgrid"&&O!=="rn"&&C){
                    ...
                    var M=a.extend({},{
                        rowabove:false,
                        rowcontent:""
                    },this.formoptions||{}),D=parseInt(M.rowpos,10)||N+1,S=parseInt((parseInt(M.colpos,10)||1)*2,10);
                    if(M.rowabove){
...
delGridRow:function(e,b){
    ...
    return this.each(function(){
        ...
        if(p.grid)if(e){
            ...
            w=p.p.id,o={},m=true,r="DelTbl_"+w,v,d,q,h,j={
                themodal:"delmod"+w,
                modalhead:"delhd"+w,
                                ...
                                if(k[0]===false){
                                    ...
                                    if(c.reloadAfterSubmit&&p.p.datatype!="local")a(p).trigger("reloadGrid");
                                        ...
                                        if(p.p.treeGrid===true)try{
                                            ...
                                            }catch(t){}else for(var I=0;I<u.length;I++)a(p).jqGrid("delRowData",u[I]);
                                        p.p.selrow=null;
                                        p.p.selarrrow=[]
                                        }
                    ...
                    if(r[0]===true){
                        ...
                        if(a.p.cellsubmit=="remote")if(a.p.cellurl){
                            ...
                            b.ajax(b.extend({
                                ...
                                a.p.serializeCellData.call(a,o):o,
                                type:"POST",
        ...
        function d(g,
            ...
            if(j.substr(0,1)=="v"){
                ...
                if(a.rows[g].cells[k].offsetLeft+a.rows[g].cells[k].clientWidth>=
                    j+parseInt(i,10))b(a.grid.bDiv)[0].scrollLeft=b(a.grid.bDiv)[0].scrollLeft+a.rows[g].cells[k].clientWidth;
