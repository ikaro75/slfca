            ...
            success:  function(data){
               ...
               $("#btn_ReenviaCodigoAutorizacion"+ surveySuffix).button().click(function() {
                ...
                $(".ocultarPreguntas").click(function() {
                    preguntasAOcultar=$(this).attr("ocultar_preguntas");
                    if (preguntasAOcultar!="") {
                        aPreguntaAocultar=preguntasAOcultar.split(",");
                        for (i=0;i<aPreguntaAocultar.length;i++) {
                            $("pregunta_" + aPreguntaAocultar[i]).parent().hide();
                            $("pregunta_" + aPreguntaAocultar[i]).parent().next().hide();
                        }
                    }
                });
                    ...
                    $(jqForm[0]).find('.obligatorio').each(function() {
                        ...
                        if (this.id!="" && this.id!=undefined)  {
                            ...
                            if ($(this).attr("type")=="radio")  {
                                if (!$("input[name='" + this.id + "']:radio").is(':ened')) {
