...
( function($) {
    ...
    $.fn.sessionmenu.handleSession = function(xml){
        ...
        $.fn.sessionmenu.options.clave_perfil=oRegistro.find("clave_perfil").text();
        $.fn.sessionmenu.options.perfil=oRegistro.find("perfil").text();
        ...
        var sHtml='<table border="0" cellspacing="0" cellpadding="0">'+
                  ...
                  '<span class="ui-state-default session_menu" ><strong>' + $.fn.sessionmenu.options.perfil + '</strong></span><br/>';
                    
                  /*if ($.fn.sessionmenu.options.clave_perfil==9) {
                    sHtml+='<a class="ui-state-default session_menu table_picker" href="#" id="lnkCerrarSesion">Seleccionar mesas</a><br/>';
                  }
                  
                  if ($.fn.sessionmenu.options.perfil==10) {
                    sHtml+='<a class="ui-state-default session_menu kitchen_picker" href="#" id="lnkCerrarSesion">Seleccionar cocinas</a><br/>';
                  } */
